...
public class SimpleGeofenceStore {
	...
	public static final String KEY_LONGITUDE = "at.fhhgb.mc.swip.geofence.KEY_LONGITUDE";
	public static final String KEY_RADIUS = "at.fhhgb.mc.swip.geofence.KEY_RADIUS";
	public static final String KEY_EXPIRATION_DURATION = "at.fhhgb.mc.swip.geofence.KEY_EXPIRATION_DURATION";
	public static final String KEY_TRANSITION_TYPE = "at.fhhgb.mc.swip.geofence.KEY_TRANSITION_TYPE";
	// The prefix for flattened geofence keys
	public static final String KEY_PREFIX = "at.fhhgb.mc.swip.geofence.KEY";
	/*
	 ...
	 * 
	 * @param _geofences
	 *            the list of simple geofences you want to save.
	 */
